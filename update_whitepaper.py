...
old_abstract_marker = "## Abstract"
table_marker = "## KMX2 Container Specification"

start_idx = text.find(old_abstract_marker)
end_idx = text.find(table_marker)

new_academic_section = r"""## Abstract
...
updated_text = text[:start_idx] + new_academic_section + text[end_idx:]

with open("docs/WHITEPAPER.md", "w", encoding="utf-8") as f:
    f.write(updated_text)

print("docs/WHITEPAPER.md aggiornato con successo!")
