...
if table_start != -1:
    ...
    full_table = """| Data Domain | Pipeline / Transform | Baseline (Zstd L3) | KolmoX (KMX2) | Gain vs Zstd | Throughput (Comp / Decomp) |
| :--- | :--- | :--- | :--- | :--- | :--- |
...
"""
    ...
    print("README.md aggiornato con throughput completi (Comp / Decomp)!")
else:
